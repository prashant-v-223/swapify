  ...
  return (
    <div className="flex flex-wrap relative md:px-4">
      <div className="w-full">
        ...
        {showProfile && (
          <div ref={profileRef} className="z-10 absolute rounded-lg right-2 bg-[#1B1B1B] px-1 py-1 flex gap-2 flex-col w-60">
            <button
              className={
                "bg-transparent group gap-2 flex w-full items-center rounded-md px-2 py-2 text-sm text-white"
              }
            >
              <img src="/assets/user.svg" alt="user" /> sswami610@gmail.com
            </button>
            <button
              className={
                "bg-transparent group gap-2 flex w-full items-center rounded-md px-2 py-2 text-sm text-white"
            ...
            >
              <img src="/assets/tick.svg" alt="user" /> Joined at : 20-10-2022
            </button>
          </div>
        )}
