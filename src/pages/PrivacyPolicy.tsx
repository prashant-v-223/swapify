const PrivacyPolicy = () => {
  return (
    ...
    <div data-aos="fade-up">
      ...
      <p>
        At SwapFry, we are committed to protecting your privacy and ensuring the
        ...
        services. By accessing or using SwapFry, you consent to the practices
      ...
      <ul className="list-disc pl-6 mb-6" >
        <li>
          ...
          contact details when you register an account, contact our support
          team, or participate in surveys or promotions.
        </li>
        <li>
          <span className="font-semibold">Financial Information:</span> To
          facilitate transactions, we may collect certain financial information,
          including your wallet addresses and transaction details.
        </li>
        <li>
          <span className="font-semibold">Log Data:</span> Our servers
          automatically collect information when you access our website or use
          our services. This includes your IP address, browser type, operating
          system, referring URLs, and other usage information.
        </li>
        <li>
          <span className="font-semibold">Cookies:</span> We may use cookies and
          similar tracking technologies to enhance your experience on our
          platform. These technologies collect information about your browsing
      ...
      <p>
        ...
        services, including processing transactions, verifying identities, and
        addressing customer inquiries. We may use your email address to send you
        updates, newsletters, or promotional materials related to SwapFry. You
        can opt out of receiving these communications at any time. We may also
        use aggregated and anonymized data for analytical purposes, market
        research, and to improve our platform's functionality and user
        experience.
      </p>
      ...
      <p>
        ...
        networks, and regular security assessments. While we strive to protect
      ...
      <p>
        ...
        obligations. We may disclose your information in response to valid legal
        requests, such as court orders or government investigations. We do not
      ...
      <p>
        ...
        Privacy Policy does not apply to those external sites or services. We
      ...
      <p>
        ...
        will be posted on our website with the revised effective date. We
      ...
      <p className="mt-8">
        By using SwapFry, you acknowledge that you have read and understood this
