  ...
  return (
    <div className="main text-white min-h-screen p-8">
      ...
      <p>
        ...
        it is important to understand and acknowledge these risks before
      ...
      <p>
        Cryptocurrencies are known for their high price volatility. The value of
        cryptocurrencies can fluctuate dramatically within short periods. Prices
        can be influenced by various factors, including market demand,
        regulatory changes, technological developments, and investor sentiment.
        As a result, there is a risk of significant financial loss when trading
        cryptocurrencies.
      </p>
      ...
      <p>
        ...
        new laws and regulations can impact the trading environment. Changes in
        government policies, regulations, or restrictions may affect the
        legality, use, and value of cryptocurrencies. Compliance with applicable
        laws and regulations is the responsibility of the user.
      </p>
      ...
      <p>
        ...
        hacking attacks, and cybersecurity breaches. While we implement security
        measures to protect your data and funds, there is no guarantee that our
        platform will be free from vulnerabilities or technical issues.
      </p>
      ...
      <p>
        ...
        understand the nature of cryptocurrencies, their underlying technology,
        and the factors that can impact their value.
      </p>

      <h2 className="text-2xl font-bold mt-8 mb-4">Financial Loss</h2>
      <p>
        Trading cryptocurrencies carries the risk of financial loss. You should
        only trade with funds that you can afford to lose. Never invest more
        than you are willing to risk, and consider seeking advice from a
      ...
      <p>
        The information provided on the SwapFry platform, including educational
        content, market analysis, and price data, is for informational purposes
        only and should not be considered as investment advice. We do not
        provide personalized financial advice or recommendations. Any decisions
        based on the information provided on our platform are made at your
        discretion and risk.
      </p>

      <h2 className="text-2xl font-bold mt-8 mb-4">No Guarantee of Results</h2>
      <p>
        Trading cryptocurrencies involves uncertainties, and past performance is
        not indicative of future results. The outcome of your trading activities
        may differ from historical data or performance metrics. There is no
        guarantee of profit or success.
      </p>
