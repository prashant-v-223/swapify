...
const Deposit = () => {
  return (
    ...
    <iframe title="Exolix widget" src="https://exolix.com/widget/BTC:BTC-ETH:ETH?a=1&locale=en&t=pEtLANcgIp5bfll5kbTOe7H0U2zyATdcjcOYyTCrztCPK8KklAHASO4quKtbDC0s" width="360px" height="376px" frameBorder="0" scrolling="yes"></iframe>
    </div>
